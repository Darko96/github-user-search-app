...
function Theme() {
  return (
    <div className="theme">
      <span className="theme-text">Light</span> {/* Dark */}
...
function Bio() {
  return (
    <div className="bio">
      <div className="user-image">{/* <img></img> */}</div>
  ...
  return (
    <div className="links">
      <div className="link">
        ...
        <span className="link-text">Belgrad</span>
      </div>
      <div className="link">
        <span className="link-img">
        ...
        <span className="link-text">www.google.com</span>
      </div>
      <div className="link">
        <span className="link-img">
        ...
        <span className="link-text">Not Available</span>
      </div>
      <div className="link">
        <span className="link-img">
          <svg height="20" width="20" xmlns="http://www.w3.org/2000/svg">
